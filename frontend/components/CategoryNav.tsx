                    ...
                    >
                        {categories.map((category) => (
                            <button
                                ...
                                className={`flex-shrink-0 px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-300 whitespace-nowrap snap-center border ${activeCategory === category.slug
                                    ? "bg-accent-terracotta border-accent-terracotta text-white shadow-[0_0_15px_rgba(224,122,95,0.4)] scale-105"
                                    : "bg-transparent border-white/20 text-gray-300 hover:border-accent-terracotta hover:text-white hover:bg-white/5"
                                    }`}
                            >
                                {category.name}
                            </button>
