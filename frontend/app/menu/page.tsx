...
// Helper to get category name removed to prevent blocking TTFB. 
// Name will be resolved on client side or via static map below.
...
export default async function MenuPage({ searchParams }: Props) {
  ...
  if (typeof categorySlug === 'string') {
    // Static fallback map for instant names without DB call
  ...
  return (
    <>
      <div className="sr-only">
        <h3>Меню Croco Sushi - Найсмачніші Роли та Суші у Львові</h3>
        <p>
