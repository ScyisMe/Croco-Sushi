  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const dataToSend = {
        ...
        weight: formData.weight || null, // Allow string like "250g"
    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-fade-in pb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-bold text-white font-display">Новий товар</h1>
            <div className="flex items-center gap-2 text-sm text-gray-400 mt-1">
              Додавання нового товару до каталогу
            </div>
          </div>
        </div>
          ...
          <div className="bg-[#141414] rounded-2xl p-6 border border-white/5 shadow-xl">
            ...
            {!formData.is_available && (
              <div className="mt-4 p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-400 text-sm flex gap-2 items-start animate-fade-in">
                ...
                <span>Увага: Цей товар за замовчуванням буде прихований з каталогу.</span>
              </div>
            )}
          </div>
