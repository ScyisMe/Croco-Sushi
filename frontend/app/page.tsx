    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <div className="sr-only">
          <h2>Доставка Суші Львів – Croco Sushi</h2>
          <p>
            Шукаєте найсмачніші суші у Львові? Ви потрапили за адресою! Croco Sushi – це преміум доставка японської кухні, яка поєднує в собі високу якість, свіжість та бездоганний сервіс.
